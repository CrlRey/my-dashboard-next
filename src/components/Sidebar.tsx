...
import { IoLogoReact, IoBrowsersOutline, IoCalculator, IoLogoWebComponent } from "react-icons/io5"
...
const menuItems = [
    ...
    },
    {
        ...
        icon: <IoLogoWebComponent    size={40} />,
        title: 'Pokemons',
        subTitle: 'Poke API'
...
<div id="menu" style={{ width: '400px'}} className="bg-gray-900 min-h-screen z-10 text-slate-300 w-64 left-0 overflow-y-scroll">
    ...
    <div id="profile" className="px-6 py-10">
     ...
     <a href="#" className="inline-flex space-x-2 items-center">
         <span>
             <Image className="rounded-full w-8 h-8" src="https://images.unsplash.com/photo-1542909168-82c3e7fdca5c" alt="User Avatar"
             width={50}
             height={50}
             />
         </span>
